//To View Pending Project Names in ListView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PendingProjects.this,MainMenu.class);
                startActivity(i);
            }
        });
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(PendingProjects.this,ViewProjectDetails.class);
                startActivity(i);
            }
        });
        ...
        btnlogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PendingProjects.this,MainActivity.class);
                startActivity(i);
            }
        });
    }
    public void SearchDBData() {
        final String URL = "https://hypognathous-pea.000webhostapp.com/eruby/external_user/get_projects.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            cl = new CustomList(PendingProjects.this, arrayList);
                            list.setAdapter(cl);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(PendingProjects.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
